...
const Experience = () => {
    ...
    return <div>
        <div className="text-2xl font-semibold mb-4 flex justify-between">Опыт работы <div className="flex gap-2"><ActionIcon onClick={() => setAddExp(true)} size="lg" color="brightSun.4" variant="subtle"><IconPlus className="h-4/5 w-4/5" />
