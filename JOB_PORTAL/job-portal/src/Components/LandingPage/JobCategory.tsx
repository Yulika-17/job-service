...
const JobCategory=()=>{
    return <div className="mt-20 pb-5">
        <div className="text-4xl text-center font-semibold mb-3 text-mine-shaft-100">Просмотр <span className="text-bright-sun-400">категорий</span> вакансий</div>
        <div className="text-lg mb-10 mx-auto text-mine-shaft-300 text-center w-1/2">Изучи разнообразные вакансии, подходящие под твои навыки. Начни карьеру уже сегодня!</div>
        ...
        >
            {
                jobCategory.map((category, index)=><Carousel.Slide key={index}>
                    <div className="flex flex-col items-center w-64 gap-2 border border-bright-sun-400 p-5 rounded-xl hover:cursor-pointer hover:shadow-[0_0_5px_2px_black] my-5 transition duration-300 ease-in-out !shadow-bright-sun-300">
                        ...
                        <div className="text-bright-sun-300 text-lg">{category.jobs} новых вакансий</div>
                    </div>
                </Carousel.Slide>) 
            }
        </Carousel>
