...
const Companies=()=>{
    return <div className="mt-20 pb-5">
        <div className="text-4xl text-center font-semibold mb-10 text-mine-shaft-100">Нам доверяют более <span className="text-bright-sun-400">1000+</span> компаний</div>
